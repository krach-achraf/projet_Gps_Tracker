 ...
 * @author HP
 */
public class PosTrackers extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PosTrackers
     */
    public PosTrackers(String nom, String prenom) {
        initComponents();
        this.nom = nom;
        this.prenom = prenom;
    ...
    private void rechercherBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rechercherBtnMouseClicked
        GPSTracker gPSTracker = gs.findBySimNumber(trackerTxt.getSelectedItem().toString());
        Date dateD = dateDebutTxt.getDate();
        Date dateF = dateFinTxt.getDate();
        if(!(dateD.equals("") || dateF.equals(""))){
            List<Position> positions = ps.findPositionsBetweenDates(gPSTracker, dateD, dateF);
            loadMap(positions);
        }else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PosTrackers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
